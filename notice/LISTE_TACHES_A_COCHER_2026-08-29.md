          ...
          [~] C.9  LA CREATION D'ANNONCE  -- a -> f TOUS CODES, ET e3 ALLUME LE 25/09
              ...
              [x] C.9-e la « tache 22 » : la RPC -- e1, e2, e3 CODES, EPROUVES, ET
                  ...
                  ➡ C.9-e = TROIS pieces, dans cet ordre de mise en service :
                    ...
                    [x] e2 le worker pose le n° Hektor sur NOTRE ligne AVANT le rafraich.
                       ...
                       ACTIF depuis le 24/09 10:52 : les 4 services redemarres par Frederic,
                    ...
                    [x] e3 la RPC donne le numero -- interrupteur en base, ETEINT ;
                       ...
                       APPLIQUE le 24/09 PAR FREDERIC (editeur SQL Supabase -- l'ecriture
                       en prod par l'outil de la session a ete bloquee par son garde-fou).
...
- [x] **C-2** la sonde d'attente voit et NOMME les deux causes — `patch_c2_sonde_attente_voit_tout_2026-09-23.sql`
      ...
      *(la bannette est remplie par le front avec l'identité — les deux côtés concordent)*.
      Mais l'audit a trouvé un défaut d'**aujourd'hui** : un contact qui sort du périmètre
