...
| **L5** | **Les gestes manquants** | **E.0-bis** *(mandat existant, photos, fusion de doublons)* · ⚠ **RENDRE MODIFIABLE CE QU'ON NE SAIT QUE CREER** *(mesure du 21/09 : 102 champs d'annonce, 40 de contact, les criteres de recherche -- creables, jamais corrigibles depuis l'app)* · **C.13** clôture du mandat · supprimer une annonce · contrôle de baisse de prix et validation **lus dans l'app** · reprise des brouillons · retirer les liens « Ouvrir Hektor » | **2–3 sem** | Plus aucun écran ne renvoie vers Hektor |
