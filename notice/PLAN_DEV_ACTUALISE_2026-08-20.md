...
| **4quinquies** | **FIGER le nom de la recherche** — il cesse d'être recalculé chaque nuit, il est relu dans le registre | **décision Frédéric, 21/08.** Fondée par `ETUDE_ORIGINE_CLE_RECHERCHE_2026-08-21.md` : Hektor ne donne **aucun identifiant** de recherche *(hier comme aujourd'hui)*, d'où le haché de contenu — ce n'était pas une négligence. ⚠️ **L'empreinte n'est PAS touchée** : elle continue de changer, c'est elle qui détecte. Figer le nom est ce qui lui permet enfin de travailler. **Périmètre : 1 endroit + 1 colonne au registre.** 15 tables, 27 fonctions, front, worker : inchangés |
