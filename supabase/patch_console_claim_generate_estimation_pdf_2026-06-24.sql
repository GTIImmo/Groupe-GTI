-- Lot 1 — Avis de valeur : autorise le worker "documents" à réclamer le job
-- generate_estimation_pdf (sinon il reste pending). Additif : reprend la fonction
-- app_console_claim_next_job LIVE et n'ajoute que 'generate_estimation_pdf' dans la
-- liste du worker_kind = 'documents'. Aucune autre ligne modifiée.
-- Réversible : voir _rollback (retirer 'generate_estimation_pdf' de la liste documents).
