create table if not exists public.app_mandat_register_current (
    ...
    mandants_texte text,
    mandat_note text,
    price_change_event_count integer not null default 0,
    price_change_last_source_kind text,
    price_change_last_old_value numeric,
    price_change_last_new_value numeric,
    price_change_last_detected_at text,
    price_change_last_source_updated_at text,
    priority text,
    offre_id text,
    offre_state text,
