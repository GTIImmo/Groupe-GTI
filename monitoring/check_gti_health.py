...
DATA_SENTINELS: list[dict[str, Any]] = [
    ...
    # --- LE GESTE ABANDONNE (01/09/2026) --------------------------------------
    # LE TROU : un geste qui echoue est rejoue 5 fois sur ~25 minutes, puis il
    # s'arrete. check_console_jobs plus bas compte les erreurs RECENTES : un
    # abandon vieux de trois jours en sort et redevient invisible. Le 29/08, deux
    # gestes sont morts et n'ont ete retrouves que trois jours plus tard.
    #
    # ⚠ PERIMETRE : LES GESTES SEULEMENT. Les SAISIES bloquees ont deja leurs
    # sentinelles -- annonce/contact/recherche _conflit et _push_bloque, six en
    # tout. J'avais d'abord ecrit qu'elles n'etaient pas surveillees : c'etait
    ...
    # SEUIL 0 : une ligne ici = quelqu'un attend, sans le savoir.
    {
        ...
        "label": "Gestes abandonnes en attente d'un humain",
