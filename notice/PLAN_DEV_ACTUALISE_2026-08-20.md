...
| **L4** 🟡 | **La création part de l'app** — **le contact y arrive** *(essai réel du 21/09 : 36 s de bout en bout, identité 10 000 001)*, ⚠ **mais il finit en DEUX fiches** *(voir le journal)* : la case cible est corrigée, la **fusion du retour** reste à faire | **L4-a** ✅ distributeurs et plages · **L4-b** 🟡 le contact naît dans l'app *(reste : le retour ne doit plus créer une seconde fiche)* · **C.9** l'annonce · **C.9-couple** · **26bis-TRANSACTIONS** · **4.3** *(contact + recherche + mandant d'un coup)* | **1,5–2 sem** | On crée **sans attendre Hektor** ; il reçoit ensuite, et **une personne = une fiche** |
